...
class AppUser {
  ...
  bool get canRestartServer => isAdmin || role == 'OPERATOR';
  ...
  factory GamePlayer.fromJson(Map<String, dynamic> json) {
    return GamePlayer(
      ...
      hoursSurvived: (json['hours_survived'] is num)
          ...
          : 0.0,
      zombieKills: (json['zombie_kills'] is num)
          ? (json['zombie_kills'] as num).toInt()
          : 0,
      weight: (json['weight'] is num)
          ? (json['weight'] as num).toDouble()
          : 80.0,
      health: (json['health'] is num)
          ? (json['health'] as num).toDouble()
          : 100.0,
      isInfected: json['is_infected'] == true,
      hunger: (json['hunger'] is num)
          ? (json['hunger'] as num).toDouble()
          : 0.0,
      thirst: (json['thirst'] is num)
          ? (json['thirst'] as num).toDouble()
          : 0.0,
      fatigue: (json['fatigue'] is num)
          ? (json['fatigue'] as num).toDouble()
          : 0.0,
      stress: (json['stress'] is num)
          ? (json['stress'] as num).toDouble()
          : 0.0,
...
const List<Map<String, String>> _allPzProfessions = [
  {'id': 'unemployed', 'name': 'Unemployed', 'desc': '8 Free Points'},
  {
    'id': 'policeofficer',
    'name': 'Police Officer',
    'desc': '+3 Aiming, +2 Reloading, +1 Sprinting',
  },
  {
    'id': 'fireofficer',
    'name': 'Fire Officer',
  ...
  },
  {
    'id': 'parkranger',
    'name': 'Park Ranger',
    'desc': '+2 Foraging, +1 Axe, +1 Carpentry, +1 Trapping',
  },
  {
    'id': 'constructionworker',
    'name': 'Construction Worker',
    'desc': '+3 Short Blunt, +1 Carpentry',
  },
  {
    'id': 'securityguard',
    'name': 'Security Guard',
    'desc': '+2 Sprinting, +1 Lightfooted, Night Owl',
  },
  {
    'id': 'carpenter',
    'name': 'Carpenter',
  ...
  },
  {
    'id': 'burglar',
    'name': 'Burglar',
    'desc': '+2 Sneaking, +2 Lightfooted, +2 Nimble, Hotwire',
  },
  {
    'id': 'chef',
    'name': 'Chef',
    'desc': '+3 Cooking, +1 Short Blade, +1 Maintenance',
  },
  {
    'id': 'repairman',
    'name': 'Repairman',
    'desc': '+2 Maintenance, +1 Carpentry, +1 Short Blunt',
  },
  ...
  {'id': 'nurse', 'name': 'Nurse', 'desc': '+2 First Aid, +1 Lightfooted'},
  {
    'id': 'lumberjack',
    'name': 'Lumberjack',
    'desc': '+2 Axe, +1 Strength, Axe Man',
  },
  {
    'id': 'fitnessInstructor',
    'name': 'Fitness Instructor',
    'desc': '+3 Fitness, +2 Sprinting',
  },
  {
    'id': 'electrician',
    'name': 'Electrician',
    'desc': '+3 Electrical, Generator Operation',
  },
  {
    'id': 'engineer',
    'name': 'Engineer',
    'desc': '+1 Electrical, +1 Carpentry, Explosive Recipes',
  },
  {'id': 'metalworker', 'name': 'Metalworker', 'desc': '+3 Metalworking'},
  {
    'id': 'mechanics',
    'name': 'Mechanics',
    'desc': '+3 Mechanics, +1 Short Blunt',
  },
  {
    'id': 'veteran',
    'name': 'Veteran',
